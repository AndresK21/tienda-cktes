...
class Marca extends Validator{
	...
	public function getMarcas(){
		$sql = "SELECT id_marca, marca FROM marca ORDER BY id_marca";
		$params = array(null);
		return Database::getRows($sql, $params);
	}
	public function searchMarca($value){
		$sql = "SELECT id_marca, marca FROM marca WHERE marca LIKE ? ORDER BY id_marca";
		$params = array("%$value%");
		return Database::getRows($sql, $params);
	}
	...
	public function readMarca(){
		$sql = "SELECT marca FROM marca WHERE id_marca = ? ORDER BY id_marca";
