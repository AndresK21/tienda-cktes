<?php
       print("
<div class='container cantidad bajar_modif'>
...
<form method='post' enctype='multipart/form-data'>
	...
	<div class='row center-align'>
        <a href='reservacion.php' class='btn waves-effect grey tooltipped' data-tooltip='Cancelar'><i class='material-icons'>cancel</i></a>
