...
<img class="responsive-img indeximage " src="../web/img/2.jpg"> 
  <h2 class="center"><b>NOSOTROS</b></h2>
    <div class ="container">
      <div class="row">
        ...
        <div class="col s12 m6 l5 right">
          <div class="card">
            <div class="card-image waves-effect waves-block waves-light">
              <img class="activator" src="../web/img/slider/slogan.jpg">
            </div>
            <div class="card-content">
              <span class="card-title activator grey-text text-darken-4">Slogan<i class="material-icons right">more_vert</i></span>
            </div>
            <div class="card-reveal">
      ...
      <div class="row">
        <div class="col s12 m6 l5 ">
          <div class="card">
            <div class="card-image waves-effect waves-block waves-light">
              <img class="activator" src="../web/img/slider/mision.jpg">
            </div>
            <div class="card-content">
        ...
        <div class="col s12 m6 l5 right">
          <div class="card">
            <div class="card-image waves-effect waves-block waves-light">
              <img class="activator" src="../web/img/slider/vision.jpg">
            </div>
            <div class="card-content">
