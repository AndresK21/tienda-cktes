...
<div class="center-align"><h4>Detalle del pedido</h4></div>
    ...
    <form method="post">
        <div class="row">
            <div class="input-field col s12 m6 l6">
                ...
                <label for="disabled" class="black-text">Cliente</label>
            </div>
            <div class="input-field col s12 m6 l6">
                <input disabled value="<?php print($pedido->getTipo_placa()) ?>" id="disabled" type="text" class="validate" />
                <label for="disabled" class="black-text">Tipo de placa</label>
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12 m6 l6">
        ...
        <div class="row">
            <div class="col s12 right-align">
                <a class='btn waves-effect red darken-3' href="index.php"><i class='material-icons'></i>Regresar</a>
