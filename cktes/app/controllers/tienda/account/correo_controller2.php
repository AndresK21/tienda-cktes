        ...
        if($cliente->setCorreo($_SESSION['correo_electronico'])){
            if($cliente->checkCorreo()){
                if($cliente->updateContra($nueva)){
                    ...
                    <tr>
                    <td bgcolor="f4f4f4">
                    <h1 style="padding 20px 0 20px 0"> Recuperaci&oacute;n de acceso</h1>
                    </td>
                    </tr>
                    <tr>
                    <td bgcolor="#f4f4f4">
                    <p> Hola <strong>'.$nombres.' </strong>Hemos detectado que su cuenta ha intentado inicarse desde dos lugares diferentes.
