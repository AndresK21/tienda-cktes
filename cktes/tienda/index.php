  ...
  <main class="caviar">
    ...
    <div class="row">
      <div class=" col s12 m12 l8 offset-l1">
        <h3 class=" caviar left-align">Categoria 1 <a href="categoria.php" target="_blank" class="pink waves-effect waves-light btn"><i class="material-icons right">apps</i>Ver m&aacute;s</a></h3>
      </div>
      <!-- PRIMER PRODUCTO -->
      <div class="col s12 m6 l3 offset-l1">
        <div class="card sticky-action">
          ...
          <div class="card-reveal cktes2">
            ...
            <p class="black-text text-darken-4">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptatibus ratione assumenda nostrum soluta hic sit culpa expedita, optio obcaecati sapiente, rerum eligendi, saepe unde iste ut alias cumque ea tempore?</p>
          </div>
        </div>
      </div>
    ...
    <div class="parallax-container">
      <div class="parallax"><img src="../web/img/1.jpg"></div>
    </div>
    ...
    <!-- CONTENEDOR DE LA SEGUNDA CATEGORIA -->
      <div class="row">
        <!-- PRIMER PRODUCTO -->
        <div class=" col s12 m12 l8 offset-l1">
          <h3 class=" caviar left-align">Categoria 2 <a href="categoria.php" target="_blank" class="pink waves-effect waves-light btn"><i class="material-icons right">apps</i>Ver m&aacute;s</a></h3>
        </div>
        <div class="col s12 m6 l3 offset-l1">
          <div class="card sticky-action">
            <div class="card-image waves-effect waves-block waves-light">
