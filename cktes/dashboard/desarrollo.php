                                    ...
                                    <form class="">
                                        <div class="row">
                                            <div class="input-field ">
                                                ...
                                                <label for="nombree" class="black-text">Nombres</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field ">
                                                <input id="usuario" type="text" class="validate">
                                                <label for="usuario" class="black-text">Apellidos</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field ">
                                                <input id="contrasena" type="text" class="validate">
                                                <label for="contrasena" class="black-text">Correo electr&oacute;nico</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field ">
                                                <input id="correo" type="email" class="validate">
                                                <label for="correo" class="black-text">Contrase&ntilde;a</label>
                                            </div>
                                        </div>
                                        <p>
